...
const quizQuestions = [ 
    {
        ...
        correctAnswer: "Моцарелла"
    },
    {
        question: "Какое время года ты любишь больше всего?",
        options: ["Зима", "Весна", "Лето", "Осень"],
        correctAnswer: "Лето"
    },
    {
        question: "Какого числа ты мне написала первый раз?",
        options: ["23 июля", "24 июля", "25 июля", "8 августа"],
        correctAnswer: "23 июля"
    }
];
...
function checkHeart(index, correctHeartIndex) {
    if (index === correctHeartIndex) {
        ...
        makeNotification('stage1-message', "Отлично! Аня, ты смогла найти ключ!!!");
...
function setupStage2() {
    ...
    function checkDecryption() {
        ...
        if (userInput.toLowerCase() === correctDecryption.toLowerCase()) {
            ...
            makeNotification('stage2-message', "Неправильно, попробуй снова.");
        }
    }
